...
{
    private static readonly Dictionary<PooledMonoBehaviour, Pool> _pools = new Dictionary<PooledMonoBehaviour, Pool>();
    ...
    private readonly Queue<PooledMonoBehaviour> _readyObjects = new Queue<PooledMonoBehaviour>();
